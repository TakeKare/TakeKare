...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a href="<?php echo Router::url("/", true); ?>" class="navbar-brand" title="<?=cfg('Site.name')?>" style="padding-top: 5px; padding-bottom: 0;"><?=$this->Html->image('logo.png')?></a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a href="<?=Router::url(array('controller' => 'users', 'action' => 'profile'))?>"><i class="fa fa-user fa-fw"></i> <?=__('User Profile')?></a></li>
                <li class="divider"></li>
                <li><a href="<?=Router::url(array('controller' => 'cities', 'action' => 'index'))?>"><i class="fa fa-folder fa-fw"></i> <?=__('Cities')?></a></li>
                <li><a href="<?=Router::url(array('controller' => 'areas', 'action' => 'index'))?>"><i class="fa fa-file fa-fw"></i> <?=__('Areas')?></a></li>
                <li><a href="<?=Router::url(array('controller' => 'teams', 'action' => 'index'))?>"><i class="fa fa-users fa-fw"></i> <?=__('Teams')?></a></li>
                <li class="divider"></li>
                <li><a href="<?=Router::url(array('controller' => 'referrals', 'action' => 'index'))?>"><i class="fa fa-file fa-fw"></i> <?=__('Referrals')?></a></li>
                <li><a href="<?=Router::url(array('controller' => 'support_types', 'action' => 'index'))?>"><i class="fa fa-file fa-fw"></i> <?=__('Support Types')?></a></li>
                <li class="divider"></li>
                <li><a href="<?=Router::url(array('controller' => 'users', 'action' => 'logout'))?>"><i class="fa fa-sign-out fa-fw"></i> <?=__('Logout')?></a></li>
            </ul>
            <!-- /.dropdown-user -->
        </li>
        <!-- /.dropdown -->
